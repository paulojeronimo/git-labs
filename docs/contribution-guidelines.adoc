...
. Update this `README.adoc` by invoking the link:{basedir}/README.update.sh[] script.
...
+
----
$ ./README.update.sh --html --serve
----
NOTE: The ruby `httpd` will be running in background.
+
