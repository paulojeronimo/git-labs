...
----
+
. After written your lab, update this README.adoc by invoking the link:README.update.sh[] script.
.. If you have {uri-asciidoctor}[asciidoctor^] installed, use the argument "--html" to this script to generate and see the README.html.
